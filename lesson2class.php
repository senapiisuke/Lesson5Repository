...
class Patient extends Person{
    ...
    public function calculateStandardWeight(){
        return "平均体重は".($this->height * $this->height * 22)."kgです。";
    }
...
$yamada = new Patient("山田", 20, "男性", 2, 80);

echo $yamada->getHeight();
echo $yamada->calculateStandardWeight();
echo $yamada->getWeight();